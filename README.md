...
**IMPORTANT!!** **HAWEI is not a fully developed software package. It was developed primarily for personal investigation**  Others are very welcome to use, inspect, adapt, or extend HAWEI if the workflow is useful for related problems.
